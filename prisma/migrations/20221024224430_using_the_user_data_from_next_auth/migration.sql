...
-- AlterTable
ALTER TABLE `Ocorrencia` MODIFY `id_pessoa` VARCHAR(191) NOT NULL;
...
-- AddForeignKey
ALTER TABLE `Ocorrencia` ADD CONSTRAINT `Ocorrencia_id_pessoa_fkey` FOREIGN KEY (`id_pessoa`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
